...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'cbfcabc3efc24057a214e075a56e1f13',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dobby', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的三和人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dobby.870322.xyz', // 网站地址
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai', 'Bitter'
  '"LXGW WenKai"', '"PingFang SC"', '-apple-system', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  FONT_SERIF: [// 衬线字体 例如'LXGW WenKai', 'Bitter'
  '"LXGW WenKai"', '"Noto Serif SC"', 'SimSun', '"Times New Roman"', 'Times', 'serif',
